...
static const uint16_t cwPiece2WordTrad[2][8] = {
  {
    0xd3ab/*[]*/, 0x4ba5/*[仕]*/, 0xdbac/*[相]*/, 0xa8b0/*皑[]*/,
    0xaea8/*ó[]*/, 0xb6ac/*[炮]*/, 0x4ca7/*[兵]*/, 0x40a1/**/
  }, {
    0x4eb1/*[]*/, 0x68a4/*[士]*/, 0x48b6/*[象]*/, 0xa8b0/*皑[]*/,
    0xaea8/*ó[]*/, 0xb6ac/*[炮]*/, 0xf2a8/*[卒]*/, 0x40a1/**/
  }
};

static const uint16_t cwDirect2WordTrad[4] = {
  0x69b6/*[]*/, 0xada5/*キ[平]*/, 0x68b0/*[退]*/, 0x40a1/**/
};

static const uint16_t cwPos2WordTrad[10] = {
  0x40a4/*[一]*/, 0x47a4/*[二]*/, 0x54a4/*[三]*/, 0x7ca5/*[四]*/, 0xada4/*き[五]*/,
  0x65ab/*[前]*/, 0xa4a4/*い[中]*/, 0xe1ab/*[後]*/, 0x40a1/**/, 0x40a1/**/
};
...
static int Word2Piece(int nArg) {
  ...
  if (false) {
    ...
    return 0;
  } else if (nArg == 0x52f1/**/ || nArg == 0xd882/**/ || nArg == 0x58d8/*[]*/) {
    return 3;
  } else if (nArg == 0x87dc/**/ || nArg == 0x8cb3/**/ || nArg == 0xcfda/*谙[]*/ || nArg == 0x6582 /**/) {
    return 4;
  } else if (nArg == 0xfcb0/*包*/ || nArg == 0x5da5/*[包]*/ || nArg == 0x68b3/**/ || nArg == 0xa5af/*[]*/) {
    return 5;
  } else {
